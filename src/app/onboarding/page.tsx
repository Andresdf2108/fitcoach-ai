...
export default function OnboardingPage() {
  ...
  async function finish() {
    ...
    router.push(profile.role === 'trainer' ? '/trainer/dashboard' : '/trainee/dashboard')
  }
  ...
  const btnSecondary = {
    height: 50, padding: '0 20px', background: 'transparent', border: '1.5px solid #e5e7eb',
    borderRadius: 12, fontWeight: 600, fontSize: 15, color: '#374151',
    cursor: 'pointer', marginTop: 8,
  }
  const inputStyle = {
        ...
        {isTrainer ? (
          <>
            ...
            <div style={{ marginBottom: 20 }}>
              <label style={{ fontSize: 14, fontWeight: 600, color: '#374151' }}>Short bio</label>
              <textarea
                placeholder="e.g. Online strength coach with 5 years experience helping busy professionals build muscle and lose fat."
                value={bio}
          ...
          <>
            ...
            <div style={{ marginBottom: 24 }}>
              <label style={{ fontSize: 14, fontWeight: 600, color: '#374151' }}>
                Injuries / notes <span style={{ color: '#9ca3af', fontWeight: 400 }}>(optional)</span>
              </label>
              <textarea
                placeholder="e.g. Lower back pain, avoid heavy deadlifts. Previous ACL surgery on right knee."
                value={injuries}
