  ...
  return (
    <div style={{
      ...
      <p style={{ color: '#52525b', fontSize: 14, margin: '0 0 6px', maxWidth: 420, lineHeight: 1.65 }}>
        This page may require database migrations that haven't been run yet.
      </p>
      <p style={{ color: '#3f3f46', fontSize: 13, margin: '0 0 28px', maxWidth: 420, lineHeight: 1.65 }}>
        If you're the admin: run migrations 003, 004, and 005 in the Supabase SQL Editor, then redeploy.
      </p>
      <button
        onClick={reset}
        style={{
